...
import org.uygar.postit.controllers.post.controller_utilities.controller_manager.initializers.statistics.charts.chunks.color.ColorChunk;
...
public class ChartGroupManager {
    ...
    public ChartGroupManager(PostController postController) {
        ...
        this.chunks.add(new ColorChunk(postController.statsPane, postController.postItGrid.getPostItOrganizer()));
    }
